...
$bi_body_model = Bing::Ngram.new(:model => "bing-body/apr10/2", :debug=>false, :user_token=>'75ed4806-a440-4ee0-9a89-24e277865b4a')
$uni_body_model = Bing::Ngram.new(:model => "bing-body/apr10/1", :debug=>false, :user_token=>'75ed4806-a440-4ee0-9a89-24e277865b4a')
